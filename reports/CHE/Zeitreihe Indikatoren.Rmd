...
```{r Mean Faktoreinkommen, include=FALSE}
...
plot(MFIncP1$years, MFIncP1$factorincome, xlab="Jahr", ylab="mittleres vorsteuer Faktoreinkommen")
```

```{r Mean Verfügbares Einkommen, include=FALSE}
...
plot(MVIncP1$years, MVIncP1$vfgbinc, xlab="Jahr", ylab="mittleres nachsteuer verfügbares einkommen")
```

```{r Median Faktoreinkommen, include=FALSE}
...
mFIncP1<-data.frame(mFIncP1)
colnames(mFIncP1)<-c("years","factorincome" )
plot(mFIncP1$years, mFIncP1$factorincome, xlab="Jahr", ylab="Median vorsteuer Faktoreinkommen")
```

```{r Median Verfügbares Einkommen, include=FALSE}
#Verfügbares Einkommen
...
mVIncP1<-data.frame(mVIncP1)
colnames(mVIncP1)<-c("years","vfgbinc" )
plot(mVIncP1$years, mVIncP1$vfgbinc, xlab="Jahr", ylab="Median nachsteuer verfügbares einkommen")
```


```{r Gini Faktor Einkommen, include=FALSE}
...
plot(GFIncP1$years, GFIncP1$factorincome, xlab="Jahr", ylab="Gini vorsteuer Faktoreinkommen")
```

```{r Gini verfügbares Einkommen, include=FALSE}
...
plot(GVIncP1$years, GVIncP1$vfgbinc, xlab="Jahr", ylab="Gini nachsteuer verfügbares einkommen")
```

```{r P8020 Faktor Einkommen, include=FALSE}
...
plot(PFIncP1$years, PFIncP1$factorincome, xlab="Jahr", ylab="P80/20 vorsteuer Faktoreinkommen")
```

```{r P8020 verfügbares Einkommen, include=FALSE}
#Verfügbares Einkommen
...
plot(PVIncP1$years, PVIncP1$vfgbinc, xlab="Jahr", ylab="P80/20 nachsteuer verfügbares einkommen")
```

```{r T10S Faktor Einkommen, include=FALSE}
...
plot(TFIncP1$years, TFIncP1$factorincome, xlab="Jahr", ylab="Top 10% vorsteuer Faktoreinkommen")
```

```{r T10S Verfügbares Einkommen, include=FALSE}
...
plot(TVIncP1$years, TVIncP1$vfgbinc, xlab="Jahr", ylab="Top 10% nachsteuer verfügbares einkommen")
```
